// Package main provides the entry point for the Any-Load proxy server
package main
...
import (
	...
	"any-load/internal/commands"
	"any-load/internal/container"
...
func runCommand() {
	...
	default:
		...
		fmt.Println("Run 'any-load help' for usage.")
		os.Exit(1)
	}
}
...
func printHelp() {
	fmt.Println("Any-Load - Multi-channel AI proxy with intelligent key rotation.")
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  any-load                    Start the proxy server")
	fmt.Println("  any-load <command> [args]   Execute a command")
	fmt.Println()
	fmt.Println("Available Commands:")
	fmt.Println("  migrate-keys    Migrate encryption keys")
	fmt.Println("  help            Display this help message")
	fmt.Println()
	fmt.Println("Use 'any-load <command> --help' for more information about a command.")
}
