...
type GroupConfig struct {
	...
	UncountedStatusCodes          *string `json:"uncounted_status_codes,omitempty"`
	...
	// 路由策略（nil 表示继承全局）
	ChannelAffinity      *bool `json:"channel_affinity,omitempty"`
	ChannelAffinityTTL   *int  `json:"channel_affinity_ttl,omitempty"`
...
type Group struct {
	...
	UncountedStatusCodeMatcher  failover.StatusCodeMatcher `gorm:"-" json:"-"`
