...
import (
	...
	db "any-load/internal/db/migrations"
...
func RunMigrateKeys(args []string) {
	...
	migrateCmd.Usage = func() {
		fmt.Println("Any-Load Key Migration Tool")
		fmt.Println()
		fmt.Println("Usage:")
		fmt.Println("  Enable encryption: any-load migrate-keys --to new-key")
		fmt.Println("  Disable encryption: any-load migrate-keys --from old-key")
		fmt.Println("  Change key: any-load migrate-keys --from old-key --to new-key")
		fmt.Println()
