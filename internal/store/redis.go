...
// RedisKeyPrefix is the prefix for all Redis keys used by Any-Load
const RedisKeyPrefix = "any-load:"
...
// Clear clears all keys with the Any-Load prefix in the current Redis database.
// This method only removes keys that belong to Any-Load, preserving other applications' data.
