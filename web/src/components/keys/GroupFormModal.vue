...
import ParamOverrideEditor from "@/components/keys/ParamOverrideEditor.vue";
...
const formData = reactive<GroupFormData>({
  ...
  test_model: "",
  validation_endpoint: "",
  param_overrides: {} as Record<string, unknown>,
...
function loadGroupData() {
  ...
  Object.assign(formData, {
    ...
    param_overrides: (props.group.param_overrides ?? {}) as Record<string, unknown>,
...
async function handleSubmit() {
  ...
  try {
    ...
    // param_overrides is emitted by the editor as the backend config object.
    const paramOverrides = formData.param_overrides;
              ...
              <div class="config-section">
                <n-form-item path="param_overrides">
                  ...
                  <param-override-editor
                    ...
                    @update:value="formData.param_overrides = $event"
                  />
                </n-form-item>
              </div>
            </n-collapse-item>
