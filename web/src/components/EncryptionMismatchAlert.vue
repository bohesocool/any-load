...
// 打开文档
const openDocs = () => {
  window.open("https://github.com/bohesocool/any-load#readme", "_blank");
};
          ...
          >
            ...
            <template v-if="scenarioType === 'data_not_encrypted'">
              ...
              <pre
                ...
                "
              >
docker compose run --rm any-load migrate-keys --to "your-encryption-key"</pre
              >
...
ENCRYPTION_KEY=your-correct-encryption-key</pre
              ...
              <div>
                ...
                <pre
                  ...
                  "
                >
docker compose run --rm any-load migrate-keys --from "old-key" --to "new-key"</pre
                >
                <p style="margin: 4px 0">
...
ENCRYPTION_KEY=your-original-encryption-key</pre
              ...
              <div>
                ...
                <pre
                  ...
                  "
                >
docker compose run --rm any-load migrate-keys --from "old-key"</pre
                >
                <p style="margin: 4px 0">
